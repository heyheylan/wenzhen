...
import {ref} from "vue";
import KnowledgeList from "@/views/Home/component/KnowledgeList.vue";
...
<template>
  <div class="home-page">
    ...
    <div class="home-banner">
      ...
      <van-tabs shrink sticky v-model:active="active" class="tab">
      ...
      <van-back-top class="van-back-top" right="30px" bottom="80px" />
    </div>
  </div>
...
.home-header {
  ...
  &::before {
    ...
    width: 100%;
    height: 90px;
    background: linear-gradient(180deg, rgb(92, 164, 92), #6dda6d);
